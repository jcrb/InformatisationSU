...
boxplot(d$DN_confor ~ d$Logiciel_2015, las = 2, par(cex.axis=0.6), col = "blue", ylab = "% conformité", main = "Date de naissance")
...
boxplot(d$DP_confor ~ d$Logiciel_2015, las = 2, par(cex.axis=0.6), col = "blue", ylab = "% conformité", main = "Diagnostic principal")
...
boxplot(d$DP_exhaus ~ d$Logiciel_2015, las = 2, par(cex.axis=0.6), col = "blue", ylab = "% exhaustivité", main = "Diagnostic principal")
```
...
boxplot(d$MS_confor ~ d$Logiciel_2015, las = 2, par(cex.axis=0.6), col = "blue", ylab = "% conformité", main = "Mode de sortie")
...
boxplot(d$DN_confor ~ d$Region, las = 2, par(cex.axis=0.6), col = "blue", ylab = "% conformité", main = "Date de naissance")
```
...
boxplot(d$DP_confor ~ d$Region, las = 2, par(cex.axis=0.6), col = "blue", ylab = "% conformité", main = "Diagnostic principal")
```
...
boxplot(d$MS_confor ~ d$Region, las = 2, par(cex.axis=0.6), col = "blue", ylab = "% conformité", main = "Mode de sortie")
```

Résultats secondaires
=====================

% de RPU ne faisant pas de remontée de RPU
------------------------------------------
```{r, echo=FALSE, comment=""}
# nettoyage
