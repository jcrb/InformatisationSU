...
```{r carto_region, echo=FALSE, fig.width=16}
...
plot(region, col = ifelse(region@data$fedoru > 0, "cornflowerblue", "gray80"), main = "Régions membres de la FEDORU (Octobre 2015)")


# on ajoute une colonne participation. Les régions participantes = 1 sinon 0
region@data$participation <- 0
region@data$participation[region@data$reg.id %in% c(42,72,53,21,26,74,93,82,73,43)] <- 1
